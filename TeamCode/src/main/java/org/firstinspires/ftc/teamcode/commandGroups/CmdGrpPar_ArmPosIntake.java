...
public class CmdGrpPar_ArmPosIntake extends ParallelCommandGroup
{
    private SubSys_Arm subSysArm;
    private SubSys_Hand subSysHand;
    private Telemetry telemetry;

    public CmdGrpPar_ArmPosIntake(SubSys_Arm subSysArm, SubSys_Hand subSysHand, Telemetry telemetry) {
