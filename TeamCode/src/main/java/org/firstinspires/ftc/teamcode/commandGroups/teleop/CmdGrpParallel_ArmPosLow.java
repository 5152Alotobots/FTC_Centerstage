...
public class CmdGrpParallel_ArmPosLow extends ParallelCommandGroup
{
    private SubSys_Arm subSysArm;
    private SubSys_Hand subSysHand;
    private Telemetry telemetry;

    public CmdGrpParallel_ArmPosLow(SubSys_Arm subSysArm, SubSys_Hand subSysHand, Telemetry telemetry) {
