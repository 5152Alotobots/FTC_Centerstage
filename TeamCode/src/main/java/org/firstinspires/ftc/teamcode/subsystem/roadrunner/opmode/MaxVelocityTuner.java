...
public class MaxVelocityTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double effectiveKf = SubSys_RoadRunner_Constants.getMotorVelocityF(veloInchesToTicks(maxVelocity));
    ...
    private double veloInchesToTicks(double inchesPerSec) {
        return inchesPerSec / (2 * Math.PI * SubSys_RoadRunner_Constants.WHEEL_RADIUS) / SubSys_RoadRunner_Constants.GEAR_RATIO * SubSys_RoadRunner_Constants.TICKS_PER_REV;
    }
}
