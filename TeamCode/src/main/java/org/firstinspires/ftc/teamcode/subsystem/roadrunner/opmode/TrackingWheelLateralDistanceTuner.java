...
public class TrackingWheelLateralDistanceTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (!(drive.getLocalizer() instanceof SubSys_RoadRunner_StandardTrackingWheelLocalizer)) {
        ...
        telemetry.addLine("Effective LATERAL_DISTANCE: " +
                (headingAccumulator / (NUM_TURNS * Math.PI * 2)) * SubSys_RoadRunner_StandardTrackingWheelLocalizer.LATERAL_DISTANCE);
