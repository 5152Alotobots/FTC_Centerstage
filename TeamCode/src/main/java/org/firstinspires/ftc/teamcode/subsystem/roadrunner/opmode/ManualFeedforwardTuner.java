...
public class ManualFeedforwardTuner extends LinearOpMode {
    ...
    private SubSys_RoadRunner drive;
    ...
    public void runOpMode() {
        ...
        drive = new SubSys_RoadRunner(hardwareMap);
        ...
        while (!isStopRequested()) {
            ...
            switch (mode) {
                case TUNING_MODE:
                    ...
                    double targetPower = Kinematics.calculateMotorFeedforward(motionState.getV(), motionState.getA(), SubSys_RoadRunner_Constants.kV, SubSys_RoadRunner_Constants.kA, SubSys_RoadRunner_Constants.kStatic);
